...
const { createAccount, createAccount2, signIn, signIn2, fetchCourseAttemptedQuestions, addAttemptedQuestion, getLandingNews, updateUserDetails, sendNewPasswordEmail, changePassword, verifyEmailAddress } = require('../controllers/user.controller')
