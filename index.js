...
app.post(`/api/${process.env.HIDDEN_ROUTE}/contact_us`, async (req, res) => {
  try {
    ...
    const recipients = [
      new Recipient(process.env.APP_EMAIL, "ProPrep Admin")
    ];

    const emailParams = new EmailParams()
      .setFrom(sentFrom)
      .setTo(recipients)
      .setSubject("Message For ProPrep Admin")
      .setHtml(`<h1 style='text-align:center'>Messge From: ${req.body.name}</h1>
